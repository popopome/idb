...
(function (root) {
    ...
    function count(proxy) { return proxy_send_command_as_ob(proxy, "count"); }
    function clear(proxy) { return proxy_send_command_as_ob(proxy, "clear"); }
    ...
    idb_proxy.get = get;
    idb_proxy.all = all;
    idb_proxy.count = count;
    idb_proxy.clear = clear;
